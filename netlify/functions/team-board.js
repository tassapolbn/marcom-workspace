...
const STYLE = '<style>'
  ...
  // hero
  + '.hero{position:relative;overflow:hidden;background:linear-gradient(160deg,#17395f 0%,#0b2344 100%);color:#fff;border-radius:22px;padding:26px 26px 22px;box-shadow:0 24px 50px -24px rgba(12,26,52,.7);animation:heroIn .7s cubic-bezier(.2,.7,.2,1) both;}'
